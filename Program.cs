...
//We start by declaring a list called "fruits" of type string and initializing it with several fruit names.//

// List<string> fruits = new List<string>() {"Lemon", "Apple", "Orange", "Lime", "Watermelon", "Loganberry"};


//We define a query expression using LINQ. The query expression starts with the "from" keyword, followed by a variable ("fruit") that represents each element in the "fruits" list.//After the "from" clause, we have a "where" clause, which specifies a condition. Here, we're filtering only those fruits that start with the letter "L" using the "StartsWith" method//

//IEnumerable<string> LFruits = from fruit in fruits
// where fruit.StartsWith("L")
// select fruit;

//we have the "select" clause, which determines the values to include in the result. In this case, we're selecting the "fruit" itself.//
